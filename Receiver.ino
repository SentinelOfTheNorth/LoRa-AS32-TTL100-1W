...
#define M1 8   //Arduino pin for M1 as well as module.
 ...
 //Setting configuration commands for RSSI of the current data signal directly.
...
void loop() {
   ...
   if(loraSerial.available() > 0){  //For receieveing data
